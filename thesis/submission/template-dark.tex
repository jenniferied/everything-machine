...
\newtcolorbox{claudemsg}{
  colback=accentgreen!8!contentbg, colframe=accentgreen!30,
  arc=3mm, boxrule=0.4pt,
  left=3mm, right=3mm, top=2mm, bottom=2mm,
  fontupper=\small, before skip=2mm, after skip=2mm,
  before upper={\textbf{\color{accentgreen}Claude}\hspace{0.5em}}
}

\newtcolorbox{usermsg}{
  colback=darkborder!15!contentbg, colframe=darkborder!40,
  arc=3mm, boxrule=0.4pt,
  left=3mm, right=3mm, top=2mm, bottom=2mm,
  fontupper=\small, before skip=2mm, after skip=2mm,
  before upper={\textbf{\color{darktext}Jennifer}\hspace{0.5em}}
}
