...
% === URL LINE BREAKING ===
\usepackage{xurl}  % Allow URL breaks at any position (must be before hyperref)
...
\newenvironment{CSLReferences}[2]
 {\begin{list}{}{%
  ...
  \setlength{\parsep}{0.15\baselineskip}
  \setlength{\itemsep}{0.3\baselineskip}}%
  \renewcommand{\bibitem}[2][]{\item}% suppress empty [] from citeproc
 }
 {\end{list}}
...
\renewcommand{\maketitle}{%
  \begin{titlepage}
    ...
    % === KEPLER POINT CLOUD (background visual, opt-in via titleimage) ===
    $if(titleimage)$
