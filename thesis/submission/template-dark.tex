...
\definecolor{accentgreen}{HTML}{3cb371} % slightly desaturated/darker green
...
% Bibliography font size (one point smaller than body)
...
\setlength{\parindent}{1cm}    % Slightly less than APA for dark theme readability
...
% Level 1: Centered, Pixel Font (VT323 larger), Accent Color
\titleformat{\section}
  {\pixelheading\fontsize{20}{26}\selectfont\centering\color{accentgreen}}
  {\thesection}{1em}{}

% Level 2: Left-aligned, Pixel Font (VT323 larger), Accent Color
\titleformat{\subsection}
  {\pixelheading\fontsize{17}{22}\selectfont\raggedright\color{accentgreen}}
  {\thesubsection}{1em}{}

% Level 3: Left-aligned, Pixel Font (VT323), Light Text
\titleformat{\subsubsection}
  {\pixelheading\fontsize{14}{18}\selectfont\raggedright\color{lighttext}}
  {\thesubsubsection}{1em}{}
...
% Table rules - invisible/transparent
...
\renewcommand{\maketitle}{%
  \begin{titlepage}
    ...
    \centering
    \parbox{0.9\textwidth}{\centering\pixeltitle\fontsize{24}{32}\selectfont\color{accentgreen}\shadowtext{\@title}}

    $if(subtitle)$
    \vspace{0.5cm}
    {\pixelsubtitle\fontsize{16}{20}\selectfont\color{accentgreen} $subtitle$ \par}
    $endif$
...
$if(toc)$
{\color{accentgreen}\tableofcontents}
\clearpage
$endif$
